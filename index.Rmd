...
3. **Describing Data** (03/04) - Descriptive statistics, t-tests. Table outputs (kable).

4. **Regressions with Data** (10/04) - Models with Zelig. Tables with Stargazer. Chunk options.

5. **Charts from Data** (17/04) - Charts in ggplot2. Scatterplots, histograms. Marginal effect plots. Colours.

6. **Combining Data** (24/04) - Merging data. Conditional data manipulation. Bibliographies in Markdown

7. **Mapping Data 1** (08/05) - Spatial analysis basics - formats, CRS. Simple Features.

8. **Mapping Data 2** (15/05) - Spatial statistics. Visualizing maps. Leaflet.

9. **Interactive Data** (22/05) - Interactive applications - shiny. 

10. **Integrated Project** (29/05) - Create your own app for cepespdata!
