...
1. Explain the Rstudio interface, options and workflow. Importing data. Viewing data. R as a calculator. Finalizing setup. Producing PDFs and web pages from markdown. 

2. Dataframe manipulation. Piping. Object types. R chunks.

3. Descriptive statistics, t-tests. Further data manipulation. Table outputs (kable).

4. Models. Stargazer. Chunk options.

5. Charts in ggplot. Scatterplots, histograms.

6. Conditional data manipulation. Marginal effect plots.

7. Spatial analysis basics - formats, CRS, SF. Plotting maps.
