...
3. On average, how many people voted in any municipality in the first round of the 2016 election?
...
6. How do male candidates differ from female candidates (`DESCRICAO_SEXO`)? Compare averages on two variables: The number of votes (`QTDE_VOTOS`) and age (`IDADE_DATA_ELEICAO`). Report the averages in a simple table. Hint: Remember to use `summarise_at`.
