...
16. Download the bibliography file `example.bib` to your working directory using the code below. Reference this bibliography file in your document and reference the Fujiwara file using its key `@Fujiwara2011`.
